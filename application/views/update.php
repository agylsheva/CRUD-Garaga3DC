  ...
  <form action="<?php echo site_url('welcome/update/'.$post->id); ?>" method="post" enctype="multipart/form-data">
    <div class="row">
      ...
      <div class="center col s12">
         <img class="responsive-img" id="image" style="border-radius:8px; font-family: Roboto;"; width="40%" src="<?php echo site_url('upload/post/'.$post->filename); ?>">
      </div>
    ...
    <div class="col s12 center">
      <button class="btn red darken-4" type="submit">Ubah</button>
    </div>
  </form>
</div>
